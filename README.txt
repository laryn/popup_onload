...
INTRODUCTION
------------
The module allows to display popup after a certain delay after a page load.
...
If you want to just display a popup after a page load, the Popup Advertisements
module possibly fits your needs. It does some very simple things:

1. Creates PopupAd entity type, so that popup advertisements are separated
...
3. Provides an action for popup ad displaying. The action can be used as
